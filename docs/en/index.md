...
features:
  ...
  - title: 智能广告过滤
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
    link: /cdn 
  ...
  - title: 开源透明
    ...
    link: /cdn 
    details: 完全开源，代码透明，社区驱动开发，安全可信赖。
    linkText: 查看节点
  ...
  - title: 响应式设计
    ...
    link: /cdn 
    details: 完美适配手机、平板、电脑等各种设备，支持键盘快捷键操作，随时随地享受观影。
    linkText: 查看节点  
